...
const  ProductId  = async ({ params }: ProductIdProps) => {
    ...
    const product = {
        ...
        description: 'The ultimate smartphone experience with professional-grade camera, all-day battery life, and stunning 6.7" AMOLED display.',
        features: [
          '6.7" Super AMOLED Display',
          'Triple Camera System (108MP + 12MP + 8MP)',
              ...
              <div className="mt-8">
                ...
                <div className="mt-4 space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-900">Wireless Earbuds Pro</h3>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-900">Smart Watch 3</h3>
